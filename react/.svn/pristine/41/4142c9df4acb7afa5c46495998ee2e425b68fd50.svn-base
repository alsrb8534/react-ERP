...
const BudgetCompFormInputComp = props => {
  const data = useSelector(({ AccReducer }) => AccReducer.BudgetReducer.budgetApplList, []);
  ...
  return (
    <>
      <AppBar color="primary" position="static">
        <Toolbar>
          <Typography variant="h5">예산편성</Typography>
...
export default BudgetCompFormInputComp;
