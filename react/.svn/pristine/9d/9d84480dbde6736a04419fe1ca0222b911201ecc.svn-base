...
import {
    ...
    delWorkplaceTO,
    saveWorkplace
} from 'ERP/LOGISTIC/BasicInfo/action/BasicInfoAction';
import MyDialog from 'util/LogiUtil/MyDialog';
import AddWorkplace from 'ERP/LOGISTIC/BasicInfo/page/AddWorkplace';
...
function WorkplaceInfo(props) {
    ...
    const { workplaceList } = useSelector(state => state.Logi.BasicInfo);
