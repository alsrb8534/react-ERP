...
import {
    ...
    saveDetailCodeList,
    searchCodeList
} from 'ERP/LOGISTIC/LogisticsInfo/action/LogisticsInfoAction';
import MyDialog from 'util/LogiUtil/MyDialog';
import AddDetailCode from './AddDetailCode';

function DetailCodeGird(props) {
    var divisionCodeNo = props.divisionCodeNo;
    const dispatch = useDispatch();
    const { detailCodeList } = useSelector(state => state.Logi.LogisticsInfo);
