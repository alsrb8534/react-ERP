...
import { savaClientInfo, searchClientInfo } from 'ERP/LOGISTIC/BasicInfo/action/BasicInfoAction';
...
function NomalClientInfo(props) {
    ...
    //*************************2020-12-01  지은 일반거래처 새로운 정보 추가 & 일괄저장 기능추가 ****************************************** */
    ...
    const { ClientInfoList } = useSelector(state => state.Logi.BasicInfo);
