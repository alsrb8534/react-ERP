...
const OrderRegist = () => {
    ...
    const handleSearchItemCode = () => {
        ...
        Axios.get('http://localhost:8282/logi/outsourc/getStandardUnitPrice.do', {
            params: param
        })
            .then(response => {
    ...
    const regist = () =>
    {
        ...
        console.log(rows);
        //Axios.post('http://localhost:8282/logi/outsourc/insertOutsourc.do',rows);

        Axios.post('http://localhost:4000/erp/logi/outsourc/insertOutsourc.do',rows);
